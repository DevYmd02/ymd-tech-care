                                    ...
                                    {row.getVisibleCells().map(cell => {
                                        ...
                                        <td 
                                            ...
                                            className={`${meta?.tdClassName || 'px-2 py-3 text-sm'} text-gray-700 dark:text-gray-300 transition-colors ${
                                                stickyType 
                                                    ? 'bg-white dark:bg-[#111827] group-even:bg-[#f9fafb] dark:group-even:bg-[#171f2d] group-hover:bg-[#f0f7ff] dark:group-hover:bg-[#1f2937]' 
                                                    : 'group-even:bg-[#f9fafb] dark:group-even:bg-[#171f2d] group-hover:bg-[#f0f7ff] dark:group-hover:bg-[#1f2937]'
                                            } ${
