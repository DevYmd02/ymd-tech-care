                ...
                <div className="p-4 sm:p-6 space-y-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                            ...
                            <div className="flex gap-2 min-w-0 flex-1">
                                <input type="text" value={formData.itemTypeCodeSearch} onChange={(e) => handleInputChange('itemTypeCodeSearch', e.target.value)} className={styles.inputFlex} placeholder="varchar(20)" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                            ...
                            <input type="text" value={formData.itemTypeName} onChange={(e) => handleInputChange('itemTypeName', e.target.value)} className={styles.inputFlex} placeholder="varchar(100)" />
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 sm:w-32 shrink-0">ชื่อ EN</label>
                            <input type="text" value={formData.itemTypeNameEn} onChange={(e) => handleInputChange('itemTypeNameEn', e.target.value)} className={styles.inputFlex} placeholder="varchar(100)" />
                        </div>
                    </div>
                </div>
