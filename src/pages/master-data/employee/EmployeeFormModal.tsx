...
import { EmployeeService, DepartmentService, PositionService } from '@/services/core/company.service';
import type { DepartmentListItem, PositionListItem } from '@project-types/master-data-types';
