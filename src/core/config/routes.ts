...
export const ROUTES = {
    ...
    MASTER_DATA: {
        ...
        EMPLOYEE_SIDE: '/master-data/employee-side',
        EMPLOYEE_DEPT: '/master-data/employee-dept',
        ...
        PRODUCT_CATEGORY: '/master-data/product-category',
        ITEM_TYPE: '/master-data/item-type',
        UOM: '/master-data/uom',
        ITEM: '/master-data/item',
        UOM_CONVERSION: '/master-data/uom-conversion',
        ITEM_BARCODE: '/master-data/item-barcode',
        ITEM_GROUP: '/master-data/item-group',
        BRAND: '/master-data/brand',
        PATTERN: '/master-data/pattern',
        DESIGN: '/master-data/design',
        GRADE: '/master-data/grade',
        MODEL: '/master-data/model',
        SIZE: '/master-data/size',
        COLOR: '/master-data/color',
        LOCATION: '/master-data/location',
        SHELF: '/master-data/shelf',
        LOT_NO: '/master-data/lot-no',
        SALES_AREA: '/master-data/sales-area',
        SALES_CHANNEL: '/master-data/sales-channel',
        SALES_TARGET: '/master-data/sales-target',
        VENDOR_TYPE: '/master-data/vendor-type',
        VENDOR_GROUP: '/master-data/vendor-group',
        CURRENCY_CODE: '/master-data/currency/code',
        CURRENCY_TYPE: '/master-data/currency/type',
        CURRENCY_RATE: '/master-data/currency/rate',
        TAX_CODE: '/master-data/tax/code',
        TAX_GROUP: '/master-data/tax/group',
        CUSTOMER: '/master-data/customer',
        CUSTOMER_BUSINESS_TYPE: '/master-data/customer-business-type',
        CUSTOMER_TYPE: '/master-data/customer-type',
        CUSTOMER_GROUP: '/master-data/customer-group',
        CUSTOMER_BILLING_GROUP: '/master-data/customer-billing-group',
    },
    SALES: {
        ...
        QUOTATION_APPROVAL: '/sales/quotation-approval',
    ...
    INVENTORY: {
        ...
        TRANSFER: '/inventory/transfer-requisition',
        TRANSFER_APPROVAL: '/inventory/transfer-requisition-approval',
        BEGINNING_BALANCE: '/inventory/beginning-balance',
...
export const placeholderRoutes: Record<string, PlaceholderRoute[]> = {
    ...
    inventory: [
        ...
        { path: 'inventory/outbound', title: 'ใบโอนย้ายสินค้าออก' },
        { path: 'inventory/inbound', title: 'ใบโอนย้ายสินค้าเข้า' },
        { path: 'inventory/beginning-balance', title: 'ยอดคงเหลือยกมา' },
        { path: 'inventory/stock-count', title: 'นับสต็อก (Stock Count)' },
