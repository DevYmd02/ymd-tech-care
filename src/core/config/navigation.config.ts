...
export const sidebarMenuItems: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            { id: 'transfer', label: 'ใบขอโอนย้ายสินค้า', path: '/inventory/transfer-requisition' },
            { id: 'transfer-approval', label: 'อนุมัติใบขอโอนย้ายสินค้า', path: '/inventory/transfer-requisition-approval' },
            { id: 'outbound', label: 'ใบโอนย้ายสินค้าออก', path: '/inventory/transfer-out' },
            { id: 'inbound', label: 'ใบโอนย้ายสินค้าเข้า', path: '/inventory/transfer-in' },
