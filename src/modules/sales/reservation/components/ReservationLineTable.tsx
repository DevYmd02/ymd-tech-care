                ...
                <table className="w-full text-sm text-left border-collapse">
                    <thead className="bg-gray-50 dark:bg-gray-800/50">
                        <tr>
                             ...
                             <th className={`${headerThClass} w-[120px]`}>ล็อต (lot_no)</th>
                             <th className={`${headerThClass} w-[100px] text-right`}>ราคา/หน่วย</th>
                             <th className={`${headerThClass} w-[130px]`}>นโยบาย (policy)</th>
                             <th className={`${headerThClass} w-[80px] text-right`}>ส่วนลด</th>
                             <th className={`${headerThClass} w-[110px] text-right`}>ยอดบรรทัด</th>
                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800 bg-white dark:bg-gray-900">
                        ...
                        {lines.length === 0 && (
                            <tr>
                                 <td colSpan={14} className="px-4 py-16 text-center text-gray-400 bg-gray-50/20 dark:bg-gray-800/10">
