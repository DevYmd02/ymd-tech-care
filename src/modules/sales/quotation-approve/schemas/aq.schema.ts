...
export const AQFormSchema = z.object({
  ...
  // Approval identity
  approval_emp_id: z.coerce.number().optional(),
  ...
  branch_id: z.coerce.number().optional().default(0),
  branch_name: z.string().optional().default(''),
  lead_id: z.string().optional().default(''),
  emp_dept_id: z.coerce.number().optional().default(0),
