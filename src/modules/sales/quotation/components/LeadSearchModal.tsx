 ...
 * @description Localized Search Modal for selecting Estimates/Leads in Quotation module.
 */
...
export const LeadSearchModal: React.FC<LeadSearchModalProps> = React.memo(({
    ...
    const { data: response, isLoading } = useQuery({
        queryKey: ['estimates-lookup', debouncedSearch],
            ...
            <div className="flex flex-col h-[70vh]">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-100 dark:border-gray-700 flex justify-between items-center px-6">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        แสดงข้อมูล <span className="font-bold text-blue-600">{estimates.length}</span> รายการ
                    </p>
                    <button 
                        onClick={onClose}
