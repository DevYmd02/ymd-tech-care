/**
 * @file ReturnFormLines.tsx
 * @description ส่วน Lines ของฟอร์มใบรับคืนจากการเบิก (Return Issue Stock)
 */
...
interface ReturnFormLinesProps {
    ...
    updateLine: (index: number, field: keyof ReturnIssueLineFormData | null, value: ReturnIssueLineFormData | unknown) => void;
    readOnly?: boolean;
...
export const ReturnFormLines: React.FC<ReturnFormLinesProps> = React.memo(
    ({
        fields,
        addLine,
        removeLine,
                    ...
                    <table className="w-full min-w-[2300px] border-collapse text-sm">
                        <thead>
                            <tr className="bg-blue-600 text-white border-b border-blue-500/30">
                                ...
                                <th className="p-3 w-32 text-right font-bold border-r border-blue-500/30 uppercase tracking-wider text-[11px]">จำนวนที่เบิก</th>
                                <th className="p-3 w-32 text-right font-bold border-r border-blue-500/30 uppercase tracking-wider text-[11px]">จำนวนรับคืน <span className="text-blue-200">*</span></th>
                                ...
                                <th className="p-3 w-36 text-right font-bold border-r border-blue-500/30 uppercase tracking-wider text-[11px]">จำนวนเงินคืน</th>
                                    ...
                                    <tr key={field._id} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/5 transition-colors group">
                                        ...
                                        <td className="p-2 border-r border-gray-100 dark:border-gray-800">
                                            <input
                                                ...
                                                type="number"
                                                disabled={readOnly}
                                                className={`${tableInputClass} text-right text-gray-500 bg-gray-50 dark:bg-gray-800 cursor-not-allowed`}
                                            />
                                        </td>
                                        ...
                                        <td className="p-2 border-r border-gray-100 dark:border-gray-800">
                                            ...
                                            />
                                            {lineErr?.qty_return_ic && <span className="text-[10px] text-red-500 font-medium block mt-0.5">{lineErr.qty_return_ic.message}</span>}
                                        </td>
...
ReturnFormLines.displayName = 'ReturnFormLines';
