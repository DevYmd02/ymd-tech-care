                    ...
                    <div className="flex gap-1">
                        <Controller
                            ...
                            render={({ field }) => (
                                <input
                                    ...
                                    className={`${inputClass} bg-emerald-50/30 dark:bg-emerald-900/10 cursor-pointer hover:bg-emerald-100/50 transition-colors ${getErrorClass('transfer_req_id')}`}
                        ...
                        {!isLocked && !watchedTransferReqId && (
                            <button
                                ...
                                className="p-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded transition-all shadow-sm active:scale-95 shrink-0 h-9 w-9 flex items-center justify-center"
                            >
                                <Search size={16} />
                            </button>
                        )}
