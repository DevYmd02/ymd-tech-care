/**
 * @file IssueFormLines.tsx
 * @description ส่วน Lines ของฟอร์มใบเบิก (Stock Issue)
 */
...
interface IssueFormLinesProps {
    fields: FieldArrayWithId<IssueStockHeaderFormData, 'lines', '_id'>[];
    addLine: () => void;
    removeLine: (index: number) => void;
    updateLine: (index: number, field: keyof IssueStockLineFormData | null, value: IssueStockLineFormData | unknown) => void;
    readOnly?: boolean;
...
export const IssueFormLines: React.FC<IssueFormLinesProps> = React.memo(
    ({
        ...
        const { register, control, getValues, formState: { errors } } = useFormContext<IssueStockHeaderFormData>();
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pb-3 border-b border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2 text-blue-600 dark:text-blue-400 flex-wrap">
                        ...
                        <h3 className="text-lg font-bold">รายการสินค้าใบเบิก — Transaction Lines</h3>
                        {icOptions && (
                            <div className="ml-2 border-l pl-3 border-gray-200 dark:border-gray-700 hidden xl:block">
                                <ICOptionSummaryBar options={icOptions} stockEffect={2} />
                            </div>
                        )}
                    </div>
...
IssueFormLines.displayName = 'IssueFormLines';
