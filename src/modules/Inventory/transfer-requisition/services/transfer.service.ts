    ...
    getById: async (
        ...
        try {
            ...
            const header: TransferRequisitionHeader = {
                ...
                doc_type_name: String(rawHeader.doc_type_name || data.doc_type_name || ''),
                transfer_docu_item_name: String(rawHeader.transfer_docu_item_name || data.transfer_docu_item_name || ''),
            ...
            const lines: TransferRequisitionLine[] = Array.isArray(rawLines) ? rawLines.map((l: Record<string, unknown>, i: number) => ({
                ...
                transfer__req_line_id: (l.transfer__req_line_id || l.transfer_req_line_id || l.id) as number | string | undefined,
                ...
                approved_qty: Number(l.approved_qty || l.appv_qty || 0),
