...
const data: VendorGroupMaster[] = [
    {
        ...
        vendor_group_nameeng: 'Furniture Group',
        is_active: true,
    ...
    },
    {
        ...
        vendor_group_nameeng: 'Stationery Group',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
    },
    {
        ...
        vendor_group_nameeng: 'Computer Group',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
    },
    {
        ...
        vendor_group_nameeng: 'Construction Materials Group',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
    },
