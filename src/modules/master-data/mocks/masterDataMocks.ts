...
const _mockItemTypes: ItemTypeListItem[] = [
    ...
    },
    {
        ...
        item_type_nameeng: 'General Supplies',
        is_active: true,
        created_at: '2024-01-01T00:00:00Z',
    },
    {
...
export const mockUnits: UOMListItem[] = IS_DEV ? _mockUnits : [];
