...
export default function ItemGroupList() {
    ...
    const [editingData, setEditingData] = useState<ItemGroup | null>(null);
    ...
    const { data: response, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            ...
            if (sortConfig) {
                items.sort((a, b) => {
                    const fieldValA = a[sortConfig.key as keyof ItemGroup];
                    const fieldValB = b[sortConfig.key as keyof ItemGroup];
    ...
    const handleEdit = useCallback((item: ItemGroup) => {
