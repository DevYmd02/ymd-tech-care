...
export default function PatternList() {
    ...
    const [editingData, setEditingData] = useState<Pattern | null>(null);
    ...
    const { data: response, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            const response = await PatternService.getAll();
            ...
            if (sortConfig) {
                items.sort((a, b) => {
                    const fieldValA = a[sortConfig.key as keyof Pattern];
                    const fieldValB = b[sortConfig.key as keyof Pattern];
    ...
    const handleEdit = useCallback((item: Pattern) => {
