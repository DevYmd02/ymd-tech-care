/**
 * @file GradeList.tsx - หน้ารายการเกรดสินค้า
 */
...
export default function GradeList() {
    ...
    const fetchData = useCallback(async () => { setIsLoading(true); try { const response = await GradeService.getAll(); setAllData(response.items); } finally { setIsLoading(false); } }, []);
