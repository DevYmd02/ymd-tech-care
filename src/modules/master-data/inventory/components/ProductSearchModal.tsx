...
const productColumns: ColumnDef<ItemListItem>[] = [
    ...
    {
        key: 'uom_name', header: 'หน่วยนับหลัก', width: '120px', align: 'center', render: (p: ItemListItem) => (
            <span className="text-xs text-gray-600 dark:text-gray-400 font-semibold">{p.base_uom_name || p.uom_name || '-'}</span>
        )
    },
];
