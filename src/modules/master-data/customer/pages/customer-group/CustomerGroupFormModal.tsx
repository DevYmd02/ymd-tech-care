...
import { useCustomerGroupForm } from './hooks/useCustomerGroupForm';
...
export function CustomerGroupFormModal({
  ...
  const {
    ...
    handleSubmit,
    setStatus,
  } = useCustomerGroupForm({ id, onSuccess, onClose, isOpen });
      ...
      {isLoading ? (
        ...
        <form id="customer-group-form" onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-1">
            ...
            <input
              name="customer_group_nameeng"
              value={formData.customer_group_nameeng}
              onChange={handleChange}
              className={styles.input}
