    ...
    return (
        <div className="space-y-4">
            {data.map((unit) => {
                ...
                return (
                    <div key={unit.unit_id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                        <div 
                        ...
                        {isExpanded && (
                            <div className="border-t border-gray-200 dark:border-gray-700 p-4">
                                <div className="flex gap-2 mb-4">
                                    <button 
                                        onClick={(e) => { e.stopPropagation(); handleEdit(unit.unit_id); }}
                                    ...
                                    <button 
                                        onClick={(e) => { e.stopPropagation(); handleStatusToggle(unit); }}
                                    ...
                                    >
                                        <Trash2 size={16} /> {unit.is_active ? 'ระงับการใช้งาน (Disable)' : 'เปิดใช้งาน (Enable)'}
                                    </button>
                                </div>
