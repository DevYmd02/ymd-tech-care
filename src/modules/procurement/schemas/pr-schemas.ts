...
export const PRLineSchema = z.object({
  ...
  line_discount_raw: z.string().optional().nullable(),
  warehouse_id: z.coerce.number().optional(),
  warehouse_code: z.string().optional().nullable(),
  location: z.string().optional().nullable(),
  uom_code: z.string().optional().nullable(),
  _standard_cost: z.number().optional(),
  _item_vendor_id: z.coerce.number().optional(),
  required_receipt_type: z.string().optional().nullable(),
  location_name: z.string().optional().nullable(),
  _base_uom_name: z.string().optional().nullable(),
...
export const PRBaseFormSchema = z.object({
  ...
  // ═══════════════════════════════════════════════════════════════════════
  cost_center_id: z.coerce.number().optional().nullable(),
  purpose: z.string().trim().optional().nullable(),

  project_id: z.coerce.number().optional().nullable(),
  pr_base_currency_code: z.string(),
  pr_quote_currency_code: z.string().optional().nullable(),
  isMulticurrency: z.boolean(),
  pr_exchange_rate: z.coerce.number().max(99999, 'ค่าต้องไม่เกิน 99,999'),
  pr_exchange_rate_date: z.string().optional().nullable(),
  preferred_vendor_id: z.coerce.number().optional().nullable(),
  vendor_name: z.string().optional().nullable(),
  delivery_date: z.string().optional().nullable(),
  credit_days: z.union([z.coerce.number(), z.string(), z.null()]).optional(),
  payment_term_days: z.union([z.coerce.number(), z.string(), z.null()]).optional(),
  vendor_quote_no: z.string().optional().nullable(),
  shipping_method: z.string().trim(),
  remark: z.string().optional().nullable(),
  lines: z.array(PRLineSchema),
  is_on_hold: z.union([z.string(), z.boolean()]),
  cancelflag: z.enum(['Y', 'N']).optional().nullable(),
  status: PRStatusEnum.optional(),
  total_amount: z.coerce.number(),
  pr_discount_raw: z.string().optional(),
  pr_tax_code_id: z.coerce.number().optional(),
  pr_tax_rate: z.coerce.number().max(99999, 'ค่าต้องไม่เกิน 99,999').optional(),
