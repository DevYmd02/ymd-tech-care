...
export const MOCK_PRT_ITEMS: PrtItem[] = [
    { id: 1, code: 'ITM-001', name: 'คอมพิวเตอร์ Notebook Dell Inspiron', uom: 'PCS', price: 25000 },
    { id: 2, code: 'ITM-002', name: 'เมาส์ไร้สาย Logistics', uom: 'PCS', price: 590 },
    { id: 3, code: 'ITM-003', name: 'คีย์บอร์ด Mechanical', uom: 'PCS', price: 3200 },
];
