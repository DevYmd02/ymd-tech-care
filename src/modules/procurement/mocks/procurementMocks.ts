...
const _mockGRNs: GRNListItem[] = [
  ...
  { grn_id: 'grn-002', grn_no: 'GRN-202603-0002', po_id: 'po-z', po_no: 'PO-202603-zzzz', received_date: '2026-03-13', warehouse_id: 'w1', warehouse_name: 'Main WH', received_by: 'u2', received_by_name: 'Staff', status: 'POSTED', item_count: 1 },
