...
// =============================================================================
// 1. PURCHASE REQUISITION (PR) - 15 Items
// =============================================================================
...
const _mockPRs: PRHeader[] = [
  ...
  },
  {
    ...
    status: 'APPROVED', pr_base_currency_code: 'THB', total_amount: 8250, attachment_count: 0,
    created_at: '2026-01-15T09:00:00Z', updated_at: '2026-01-16T10:00:00Z', created_by_user_id: 1, updated_by_user_id: 2,
...
const _mockPOs: POListItem[] = [
  ...
  { po_id: 'po-006', po_no: 'PO-202602-0006', po_date: '2026-02-05', pr_id: 'pr-003', vendor_id: 'v001', vendor_name: 'IT Supply Co.', branch_id: 'br1', status: 'ISSUED', currency_code: 'THB', exchange_rate: 1, payment_term_days: 30, subtotal: 50000, tax_amount: 3500, total_amount: 53500, created_by: 'u1', item_count: 2 },
  ...
  { po_id: 'po-001', po_no: 'PO-202601-0001', po_date: '2026-01-25', pr_id: 'pr-001', vendor_id: 'v002', vendor_name: 'OfficeMate', branch_id: 'br1', status: 'CLOSED', currency_code: 'THB', exchange_rate: 1, payment_term_days: 30, subtotal: 8250, tax_amount: 577.5, total_amount: 8827.5, created_by: 'u1', item_count: 2 },
];
...
const _mockGRNs: GRNListItem[] = [
  ...
  { grn_id: 'grn-005', grn_no: 'GRN-202602-0005', po_id: 'po-002', po_no: 'PO-202602-0002', received_date: '2026-02-15', warehouse_id: 'w1', warehouse_name: 'Main WH', received_by: 'u2', received_by_name: 'Staff', status: 'RETURNED', item_count: 5 },
  ...
  { grn_id: 'grn-002', grn_no: 'GRN-202603-0002', po_id: 'po-z', po_no: 'PO-202603-zzzz', received_date: '2026-03-13', warehouse_id: 'w1', warehouse_name: 'Main WH', received_by: 'u2', received_by_name: 'Staff', status: 'POSTED', item_count: 1 } as unknown as GRNListItem,
