...
const productColumns: ColumnDef<ItemListItem>[] = [
    ...
    {
        key: 'uom_name', header: 'หน่วย', width: '120px', render: (p: ItemListItem) => (
            <span className="text-xs text-gray-600 dark:text-gray-400">{p.uom_name || p.uom_name || p.base_uom_name || '-'}</span>
        )
    },
];
