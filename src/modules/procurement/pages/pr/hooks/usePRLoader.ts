...
import { getDefaultFormValues, createEmptyLine } from '@/modules/procurement/schemas/pr-schemas';
        ...
        try {
          ...
          if (pr) {
            ...
            const formData: PRFormData = {
              ...
              ...(pr.project_id !== undefined && { project_id: pr.project_id || '' }),
              ...
              requester_user_id: pr.requester_user_id || '1',
